...
for(let i = 0; i < 30; i++) {
  ...
  blogPosts.push({
    ...
    image1: (() => {
      const id = ["1181244", "3183150", "3182812", "3183183", "3184292", "3184339", "1181675", "3861969", "546819", "3184360", "3184311", "7378", "1181263", "1181270", "1181271", "3182750"][i % 16];
      return `https://images.pexels.com/photos/${id}/pexels-photo-${id}.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2`;
    })(),
    image2: (() => {
      const id = ["1181271", "3182750", "1181244", "3183150", "3182812", "3183183", "3184292", "3184339", "1181675", "3861969", "546819", "3184360", "3184311", "7378", "1181263", "1181270"][i % 16];
      return `https://images.pexels.com/photos/${id}/pexels-photo-${id}.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2`;
    })(),
